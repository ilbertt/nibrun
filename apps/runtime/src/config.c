...
/* PORT, NIBRUN_HOSTNAME, NIBRUN_DATA_DIR, NIBRUN_PUBLIC_IPV4, NIBRUN_EXTRA_PUBLIC_PORT, HOME
 * and TMPDIR, on top of whatever the tenant configured. */
#define BASE_VARIABLES 7
