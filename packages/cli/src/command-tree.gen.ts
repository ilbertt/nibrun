...
import type { command as appsActivationCmd } from './commands/apps/activation.ts';
...
export const commandTree: RuntimeNode = {
  ...
  literalChildren: {
    'apps': {
      ...
      literalChildren: {
        'activation': {
          segment: { kind: 'literal', value: 'activation' },
          command: { path: 'apps activation', load: () => import('./commands/apps/activation.ts').then((m) => m.command) },
          literalChildren: {},
          paramChild: null,
        },
        'delete': {
