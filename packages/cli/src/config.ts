...
import { DASHBOARD_URL } from '@repo/global-constants';
...
/** The dashboard's origin, because the api is what serves it: one host answers both. */
export const DEFAULT_API_URL = DASHBOARD_URL;
